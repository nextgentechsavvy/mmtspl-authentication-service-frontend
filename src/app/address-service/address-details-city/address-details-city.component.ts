...
@Component({
  selector: 'app-address-details-city',
  templateUrl: './address-details-city.component.html',
  styleUrls: ['./address-details-city.component.css']
})

export class AddressDetailsCityComponent implements OnInit {
